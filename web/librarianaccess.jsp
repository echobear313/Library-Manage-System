...
<html>
  <head>
    ...
    <title>CTE.Library: Librarian Access.</title>
  ...
  <body>
    ...
    <div style="margin-left: 2em">
      ...
      <form action="/Library/LibrarianCheckoutController" method="post">

        Book ID<b><sup><a href="#bookID">*</a></sup></b>:<br>

        <b class="error">
         <% if (session.getAttribute("checkoutbook")!=null){
	   out.println((String)session.getAttribute("checkoutbook"));}%>
        </b><br>
	...
	<!-- Get the member's ID number. -->
        ...
        <b class="error"><%
	 if (session.getAttribute("checkoutmember")!=null){
	   out.println((String)session.getAttribute("checkoutmember"));}%>
        </b><br>
	...
	<!-- Display a form that allows a librarian to send books to the
      ...
      <form action="/Library/LibrarianCheckinController" method="post">

        Book ID<b><sup><a href="#bookID">*</a></sup></b>:<br>

        <b class="error">
	<%
	 if (session.getAttribute("checkinbook")!=null){
	   out.println((String)session.getAttribute("checkinbook"));}%>
        </b><br>
