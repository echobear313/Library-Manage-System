...
public class Library
{
	...
	if ( approveCheckout( bookId, memberSSN ) ) {
		...
		checkedOut = myConnection.runUpdate( sqlQuery );
	    } else {
		...
		sqlQuery[1] =  "UPDATE Book SET borrowerssn = " + memberSSN +
		    ...
		    ", duedate = '" + dd + "' " +
		    "WHERE bookid = " + bookId;
		checkedOut = myConnection.runChainedUpdate( sqlQuery, "SERIALIZABLE" );
	    }
	}
	return checkedOut;
    }
     ...
     * @return Librarian
     */
    public Librarian validateLibrarian( String ssn, String passWord ) 
	throws Exception {
     ...
     * @return Member
     */
    public Member validateMember( String ssn, String passWord ) 
	throws Exception{
